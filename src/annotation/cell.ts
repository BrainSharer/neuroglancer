...
import { AnnotationType, Cell } from '#/annotation';
import { 
...
`);
  ...
  // TODO(jbms): This rendering for the 1d case is not correct except for 
  // cross-section/orthographic projection views where the "z" dimension is 
  // orthogonal to the single annotation chunk
  // dimension.
